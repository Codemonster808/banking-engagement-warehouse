...
@given(
    "a pipeline that breached its 60 second SLA by running for 120 seconds",
    target_fixture="sla_pipeline_id",
)
...
@when(
    "the same pipeline breaches its SLA again for the same run_date",
    target_fixture="second_check",
)
