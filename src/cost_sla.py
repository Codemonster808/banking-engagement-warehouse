...
def record_pipeline_run(pipeline_id: str, run_date: str, bytes_processed: int, duration_seconds: float) -> dict:
...
if __name__ == "__main__":
    ...
    print(record_pipeline_run("dim_customer_scd2", today, bytes_processed=50_000_000, duration_seconds=42.0))
